...
render("rmds/figures.RmD", output_format = "all", output_dir = "reports", envir = new.env())
render("rmds/figures-supp.RmD", output_format = "all", output_dir = "reports", envir = new.env())
