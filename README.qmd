...
Load sandbar shark maternity data set. Rows are data from individuals sharks.
...
*x* is fork length (cm) and *z* is maternal status (0 = non maternal, 1 = maternal).
...
Bin data into suitable length categories for plotting. Add marginal rug plots to show individual data points.
