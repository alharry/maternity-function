...
Figure 4. Confidence interval coverage for $\hat{L'_{50}}$ for 3PLF methods (high selectivity scenarios). Figure shows the percentage of simulations (n = 300) where the true parameter value fell within the 50% bootstrap confidence interval. Point size denotes mean number of females in maternal condition at a given sample size. \
\
\newpage
