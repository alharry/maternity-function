...
```
Figure S11. Accuracy (per cent absolute error) in $R_{0}$ calculated using maternity parameters obtained from alternative logistic regression models. Each point reflects a mean value from 300 simulated data sets. Point size denotes mean number of females in maternal condition at a given sample size.
